...
pass  # TEST: skip quantity_run_standard ST1
...
pass  # TEST: skip quantity_run_standard ST2
...
for i in range(col_num):
	...
	spx_quantity_result = None  # TEST: skip quantity_run_sample
	cur_concentration_list = [10.0] * 8  # TEST: dummy concentration
...
pass  # TEST: skip output_quantitative_data
