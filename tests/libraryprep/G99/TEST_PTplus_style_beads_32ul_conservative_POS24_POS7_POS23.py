...
# Parameter style: PTplus conservative second-bead-transfer style with PTseq 32 uL volume.
#####################################################################
...
test_name = "TEST_PTplus_style_beads_32ul_conservative_POS24_POS7_POS23"
parameter_style = "PTplus conservative second-bead-transfer style with PTseq 32 uL volume"
print(test_name)
...
p1_mix({"Position": bead_stock["Position"], "Col": bead_stock["Col"], "Row": bead_stock["Row"], "PreAirVolume": 10, "MixTimes": 20, "MixAspirateSpeed": 300, "MixAspirateOffsetOfZ": 0.8, "MixVolume": 900, "MixDispenseOffsetOfZ": 30, "MixDispenseSpeed": 400, "DelayAfterMixLoop": 1, "MixEmptyOffsetOfZ": 30, "MixEmptySpeed": 50, "PreAirSpeed": 100, "DelayAfterMixAspirate": 0, "DelayAfterMixDispense": 0, "DelayAfterMixEmpty": 15, "TipTouchTimes": 3, "PostAirSpeed": 100, "PostAirVolume": 0, "FirstSegmentSpeed": 190, "SpeedChangeOffsetOfZ": 0, "SecondSegmentSpeed": 100, "TipTouchOffsetOfZ": 30, "TipTouchRangeOfX": 1.2, "TipTouchSpeed": 100})
for i in range(8):
