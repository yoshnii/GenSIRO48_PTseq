...
for i,poolings in enumerate(temp):
	...
	for sample in samples:
		...
		if not sample.NeedDilution:
			...
			p8_aspirate_modified(sample.SampleWellPosition, sample.SampleWellRow, sample.SampleWellColumn, 2, PreAirVolume=10, AspirateSpeed=80, AspirateOffsetOfZ=0.5, DelayAfterAspirate=0.5, PostAirVolume=0)
